...
| 구분 | 수집 방식 | 대상 | API 키 |
|------|-----------|------|--------|
| **MVP** | 스크래핑만 | SW중심대학, 패스트캠퍼스, 멋사 등 | 불필요 |
...
| 수집 방법 | 적용 대상 | MVP/Phase2 |
|-----------|-----------|------------|
| **HTML 스크래핑** | SW중심대학, 패스트캠퍼스, 멋사, 엘리스, 코드잇, 커리어리, 모두의연구소 | **MVP** (API 불필요) |
| **API** | 사람인, 원티드, 워크넷, 나라장터 | Phase 2 (키 승인 후) |
| **API (신청 제한)** | 잡코리아 | Phase 2 |
